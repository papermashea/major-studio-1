...
// import {cloud} from './node_modules/d3-cloud/index.js';
// import {d3array} from './node_modules/d3-array/dist/d3-array.js';
...
d3.JSON("data/colorObjY.").then((words) => {
// d3.text("data/types.txt").then((words) => {

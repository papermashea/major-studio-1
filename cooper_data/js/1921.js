...
const all = '*'
const url = `${searchBaseURL}?${method}&access_token=${CH_KEY}&year_started=${year}&type_id=${all}&media_id=${all}&woe_id=${all}&${img}&${ip}&per_page=500`
var API_PORT = 443;
...
setTimeout(() => {
    fs.writeFileSync('ch1921.json', JSON.stringify(wordArray), 'utf8')
}, 5000)
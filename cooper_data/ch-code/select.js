...
d3.csv("data/2021_pantone.csv").then(function (data) {
    ...
    // Listen to click on "year" and "yearAcq" buttons and trigger redraw when they are clicked
    d3.selectAll(".measure").on("click", function() {
        ...
        if (thisClicked === Count.yearAcq) {
            chartState.legend = Legend.yearAcq;
        }
        redraw();
    });
    ...
    function redraw() {
        ...
        if (chartState.measure === Count.yearAcq) {
        ...
        let simulation = d3.forceSimulation(dataSet)
            ...
            .force("x", d3.forceX(function(d) {
                // Mapping of values from year/yearAcq column of dataset to range of SVG chart (<margin.left, margin.right>)
